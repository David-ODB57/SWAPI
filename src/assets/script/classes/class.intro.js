export class Intro {
  ...
  #init() {
    ...
    div.setAttribute("id", "start-app");
    button.setAttribute("type", "button");
    button.innerText = "Start";
    div.appendChild(button);
    this.#el.appendChild(div);
    document
      .querySelector("#start-app > button")
                        ...
                        <section class="star-wars">
                            ...
                            <div class="title">
                                <h1>
                                  ...
                                  <span>The Return Of The Coderz</span>
                                </h1>
                            </div>
                            <p>
                                La galaxie du coding va mal, l'holonet est sous la férule de la Fédération des GAFAM.
                                Ils gouvernent d'une main de fer et impose leur loi à tous...
                            </p>
                            <br />
                            <p>
                                Après moultes péripéties à travers les méandres de l'holonet, SWAPI
                                vit le jour dans le sang et les larmes dans les bureaux de développement des Bothans. 
                                Restant ainsi caché au yeux du nouvel ordre galactique.
                            </p>
                            <br />
                            <p>
                                Afin de pouvoir renverser l'ordre établit par la Fédération galactique des GAFAM,
                                SWAPI fut mis en ligne par la rébellion.
                            </p>
                            <br />
                            <p>
                                Après avoir rejoint les rangs de la Rebellion, vous avez été affecté
                                au sein du fameux réseau d'espionnage Bothan.
                            </p>
                            <br />
                            <p>
                                SWAPI met à votre disposition une base de données de personnages de
                                Star Wars.
                            </p>
                            <br />
                            <p>
                                Vous pourrez consulter la liste et y ajouter des personnages, ou
                                bien en supprimer ou en modifier les informations, ceci seulement en
                                un simple clique sur les vignettes qui apparaitront dans la liste.
                            </p>
                            <br />
                            <p>
                                Vous accèderez aux options modifier et supprimer pour un personnage
                                sur la page détails après avoir cliqué sur sa vignette.
                            </p>
                            <br />
